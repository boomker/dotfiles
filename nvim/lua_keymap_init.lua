...
local plug_map = {
	...
	["n|<leader>lt"] = map_cr("LSoutlineToggle"):with_noremap():with_silent(),
	...
	["n|<leader>fg"] = map_cr("lua toggle_lazygit()"):with_noremap():with_silent(),
	...
	-- Plugin nvim-tree
	["n|<Leader>fe"] = map_cr("NvimTreeToggle"):with_noremap():with_silent(),
	["n|<Leader>nf"] = map_cr("NvimTreeFindFile"):with_noremap():with_silent(),
	["n|<Leader>rt"] = map_cr("NvimTreeRefresh"):with_noremap():with_silent(),
	-- Plugin Undotree
	["n|<Leader>ut"] = map_cr("UndotreeToggle"):with_noremap():with_silent(),
	-- Plugin Telescope
	...
	["n|<leader>vm"] = map_cr("MarkdownPreviewToggle"):with_noremap():with_silent(),
	-- Plugin auto_session
